...
/**
 * Created by kennymac on 15/10/12.
 */
public final class USize {
     ...
     */
    public static USize parseSize(String string)
...
//        checkNotNull(string, "string must not be null");
        ...
        try {
            return new USize(Integer.parseInt(string.substring(0, sep_ix)),
